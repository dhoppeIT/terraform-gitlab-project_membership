...
| <a name="input_expires_at"></a> [expires\_at](#input\_expires\_at) | Expiration date for the project membership. Format: YYYY-MM-DD | `string` | `null` | no |
| <a name="input_member_role_id"></a> [member\_role\_id](#input\_member\_role\_id) | The ID of a custom member role. Only available for Ultimate instances | `number` | `null` | no |
